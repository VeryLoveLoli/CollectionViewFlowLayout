//
//  CollectionViewAlignFlowLayout.swift
//  
//
...
/**
 对齐流布局
 */
open class CollectionViewAlignFlowLayout: UICollectionViewFlowLayout {
    ...
    /// 对齐方式
    open var align: CollectionViewAlignFlowLayout.Align = .none
